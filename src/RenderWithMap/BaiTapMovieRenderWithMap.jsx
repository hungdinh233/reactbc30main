...
import "../assets/styles/concac.css";
const data = [
  {
    maPhim: 1283,
    tenPhim: "Trainwreck",
...
export default class BaiTapMovieRenderWithMap extends Component {
  render() {
    return (
      <div className="content">
        <div style={{ background: "rgba(0,0,0,0.7)", minHeight: "200vh" }}>
          <nav
              ...
              {data.map((prod, index) => {
                return (
                  <div className="col-2 mt-2" key={index}>
                    <div className="card">
                      <img src={prod.hinhAnh} alt="..."></img>
                      <div className="card-body bg-dark text-white">
                        <h2 style={{height:100, fontSize: 20}}>{prod.tenPhim}</h2>
